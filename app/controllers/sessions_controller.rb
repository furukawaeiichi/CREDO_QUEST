    ...
    list_data = [
      {
        ...
        todos: [
          ...
          "わからないことは、恥ずかしがらずにオープンにしよう！（Twitter, timesなど）",
          "自分の良い・悪い習慣をシェアしてより良くしよう！（Twitter, timesなど）",
          "同期限定イベントに参加して、10人と喋ろう！",
          "全体懇親会に参加して、10人と喋ろう！",
      ...
      },
      {
        title: "Move Fast",
        todos: [
          "すぐ返信する習慣をつけよう！（できない時はスタンプ）",
          "「e-typing」タイピングバラエティ（レベルA）or「寿司打」お勧めコースをクリアをしよう！",
          "紙やtimesにわからないことを書き出して、問題を分解しよう！",
          "「何について」「何分間調べるか」決めて集中してググろう！（思考と作業の分離）",
          "わからないことメモ一覧を作って、大体の理解で次へ。わかるようになったらチェックしよう！（成功脳・学習の見える化）",
          "1日1つ学んだこと（単語の意味、ショートカットキー、コマンドなど）を発信しよう！",
      ...
      },
      {
        title: "Give First",
        todos: [
          "他の受講生の投稿にコメントorスタンプする習慣をつけよう！（Twitter, timesなど）",
          "人のためになる情報（記事や本、イベントなど）をシェアしよう！",
          "頑張っている人をMattermost「Nice Active !」で投票しよう！",
          "グループワークに自分の得意なことで貢献しよう！",
          "他の受講生がわからない問題を、一緒に考えてみよう！",
          "Discord「救済部屋」のメッセージ欄から協力しよう！",
          "後輩のわからないところを教えてみよう！",
          "カリキュラムで自分が詰まったところを解説しよう！（Notion, Qiita, LT会など）",
      ...
      },
      {
        title: "Geek Out",
        todos: [
          "timesに学んだ知識を書いてみようor他の受講生に説明してみよう！",
          "学んだ技術が日常のどんな所で使われるか、結びつけながら学ぼう！",
          "フォーマットを埋めて、質問の初投稿しよう！",
          "カリキュラムで学んだことで、簡単なオリジナルアプリを作ろう！（チーム開発もおすすめ！）",
